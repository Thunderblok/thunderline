defmodule Thunderline.Thunderbolt.CA.RuleActionsTest do
  ...
  test "parse_rule action happy path" do
    input = Ash.ActionInput.for_action(Thunderline.Thunderbolt.CA.RuleActions, :parse_rule, %{line: "B3/S23 rate=10Hz"})
  ...
  test "parse_rule action error" do
    input = Ash.ActionInput.for_action(Thunderline.Thunderbolt.CA.RuleActions, :parse_rule, %{line: "notarule"})
