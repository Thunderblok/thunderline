defmodule Thunderline.Chat.Message do
  use Ash.Resource,
    otp_app: :thunderline,
    domain: Thunderline.Chat,
    extensions: [AshOban],
  ...
  oban do
    triggers do
      trigger :respond do
        ...
        worker_module_name(Thunderline.Chat.Message.Workers.Respond)
        scheduler_module_name(Thunderline.Chat.Message.Schedulers.Respond)
  ...
  actions do
    ...
    create :create do
      ...
      change Thunderline.Chat.Message.Changes.CreateConversationIfNotProvided
    ...
    update :respond do
      ...
      transaction? false
      change Thunderline.Chat.Message.Changes.Respond
    end
  ...
  pub_sub do
    module ThunderlineWeb.Endpoint
    prefix "chat"
  ...
  attributes do
    ...
    attribute :source, Thunderline.Chat.Message.Types.Source do
      allow_nil? false
      public? true
      default :user
    end
  ...
  relationships do
    belongs_to :conversation, Thunderline.Chat.Conversation do
      public? true
      allow_nil? false
    end
