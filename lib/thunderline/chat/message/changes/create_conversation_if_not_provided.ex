defmodule Thunderline.Chat.Message.Changes.CreateConversationIfNotProvided do
  ...
  def change(changeset, _opts, context) do
    if changeset.arguments[:conversation_id] do
      ...
      Ash.Changeset.before_action(changeset, fn changeset ->
        conversation = Thunderline.Chat.create_conversation!(Ash.Context.to_opts(context))
