defmodule Thunderline.Support.ErrorKinds do
  ...
  # Older Broadway versions raise {:error, :no_producers} tuples or custom exceptions.
  def classify({:error, :no_producers}), do: {:transient, :no_producers_available}
  def classify({:no_producers_available, _reason}), do: {:transient, :no_producers_available}
