defmodule Thunderline.Thundergrid.Resources.GridZone do
  ...
  validations do
    ...
    validate match(:hex_coordinates, ~r/.+/), message: "Coordinates must be a valid object", where: [present(:hex_coordinates)]
  end
  ...
  actions do
    ...
    create :create do
      accept [:zone_name, :zone_type, :hex_coordinates, :zone_radius,
              :capacity_limits, :zone_properties, :governance_rules,
              :environmental_factors, :metadata]
    ...
    update :update do
      accept [:zone_name, :zone_type, :capacity_limits, :zone_properties,
              :governance_rules, :environmental_factors, :metadata]
    end
    ...
    update :connect_zone do
      ...
      change fn changeset, context ->
        ...
        updated_connections = if target_id in current_connections do
          current_connections
        else
