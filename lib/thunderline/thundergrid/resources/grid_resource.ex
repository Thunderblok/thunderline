defmodule Thunderline.Thundergrid.Resources.GridResource do
  ...
  attributes do
    ...
    attribute :resource_type, :atom do
      ...
      default :material
      constraints one_of: [:material, :energy, :structure, :data, :agent, :landmark, :portal, :artifact]
    end
    ...
    attribute :resource_status, :atom do
      ...
      default :active
      constraints one_of: [:active, :dormant, :depleted, :regenerating, :damaged, :destroyed, :protected]
    end
  ...
  actions do
    ...
    create :create do
      accept [:resource_name, :resource_type, :resource_subtype, :hex_coordinates,
              :precise_position, :quantity_data, :physical_properties, :interaction_rules,
              :ownership_data, :economic_data, :spatial_effects, :discovery_data,
              :zone_id, :coordinate_id, :metadata]
    ...
    update :update do
      accept [:resource_name, :resource_subtype, :quantity_data, :physical_properties,
              :interaction_rules, :ownership_data, :economic_data, :spatial_effects,
    ...
    action :claim_ownership, :struct do
      ...
      run fn input, _context ->
        case Ash.get!(Thunderline.Thundergrid.Resources.GridResource, input.arguments.id) do
          nil -> {:error, "Grid resource not found"}
          resource ->
            ownership_data = %{
            ...
            updated_resource = Ash.update!(resource, :_claim_ownership_internal, %{
      ...
      run fn input, _context ->
        case Ash.get!(Thunderline.Thundergrid.Resources.GridResource, input.arguments.id) do
          ...
          resource ->
            ...
            updated_resource = Ash.update!(resource, :_release_ownership_internal, %{
              ownership_data: ownership_data,
              last_interaction: DateTime.utc_now()
            })
    ...
    action :relocate, :struct do
      ...
      run fn input, _context ->
        case Ash.get!(Thunderline.Thundergrid.Resources.GridResource, input.arguments.id) do
          nil -> {:error, "Grid resource not found"}
          resource ->
            updated_resource = Ash.update!(resource, :_relocate_internal, %{
      ...
      run fn input, _context ->
        case Ash.get!(Thunderline.Thundergrid.Resources.GridResource, input.arguments.id) do
          ...
          resource ->
            ...
            updated_resource = Ash.update!(resource, :_regenerate_internal, %{
              quantity_data: updated_quantity_data,
              resource_status: new_status
            })
