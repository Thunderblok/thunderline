defmodule Thunderline.Thundercom.Resources.Channel do
  @moduledoc """
  ...
  attributes do
    ...
    attribute :channel_type, :atom do
      ...
      default :text
      constraints [one_of: [:text, :voice, :announcement, :ai_agent, :pac_coordination, :media, :forum]]
    end
  ...
  has_many :messages, Thunderline.Thundercom.Resources.Message do
  ...
  actions do
    ...
    create :create do
      ...
      accept [:channel_name, :channel_slug, :channel_type, :channel_category, :visibility,
              :topic, :channel_config, :voice_config, :permissions_override, :created_by,
              :channel_integrations, :moderation_config, :position, :tags, :metadata, :community_id]
    ...
    update :update do
      ...
      accept [:channel_name, :channel_type, :channel_category, :visibility, :topic,
              :channel_config, :voice_config, :permissions_override, :channel_integrations,
              :moderation_config, :position, :tags, :metadata]
    end
    ...
    action :leave_channel do
      ...
      run fn input, context ->
        ...
        updated_channel = Ash.Changeset.for_update(channel, :internal_update_metrics, %{
    ...
    action :pin_message do
      ...
      run fn input, context ->
        ...
        updated_pinned = if message_id in current_pinned do
          current_pinned
        else
    ...
    action :update_metrics do
      ...
      run fn input, _context ->
        ...
        result = Ash.update!(channel, :_internal_update_metrics, %{channel_metrics: updated_metrics})
        {:ok, result}
      end
    end
