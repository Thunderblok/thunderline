defmodule Thunderline.Thundercom.Resources.PACHome do
  @moduledoc """
  ...
  actions do
    ...
    action :suspend, :struct do
      ...
      run fn input, context ->
        # Get the PAC home
        pac_home = Ash.get!(Thunderblock.Resources.PACHome, input.arguments.id)
  ...
  #   trigger :scheduled_backups do
  #     action :backup_needed
  #     schedule "0 2 * * *"  # Daily at 2 AM
  #   end

  #   # Auto-unsuspend expired suspensions
  #   trigger :auto_unsuspend_expired do
  #     action :auto_unsuspend
  #     schedule "*/60 * * * * *"  # Every minute
  #   end

  #   # Cleanup terminated PAC homes
  #   trigger :cleanup_terminated_homes do
  #     action :cleanup_terminated
  #     schedule "0 3 * * *"  # Daily at 3 AM
  #   end

  #   # Resource usage monitoring
  #   trigger :resource_monitoring do
  #     action :resource_usage, args: [90]
