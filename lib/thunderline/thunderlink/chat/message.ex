defmodule Thunderline.Thunderlink.Chat.Message do
  use Ash.Resource,
    otp_app: :thunderline,
    domain: Thunderline.Thunderlink.Chat,
    extensions: [AshOban],
  ...
  actions do
    ...
    create :create do
      ...
      change Thunderline.Thunderlink.Chat.Message.Changes.CreateConversationIfNotProvided
    ...
    update :respond do
      ...
      transaction? false
      change Thunderline.Thunderlink.Chat.Message.Changes.Respond
    end
  ...
  attributes do
    ...
    attribute :source, Thunderline.Thunderlink.Chat.Message.Types.Source do
      allow_nil? false
      public? true
      default :user
    end
  ...
  relationships do
    belongs_to :conversation, Thunderline.Thunderlink.Chat.Conversation do
      public? true
      allow_nil? false
    end
