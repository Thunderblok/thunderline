defmodule Thunderline.Thunderlink.Chat.Message.Changes.Respond do
  ...
  def change(changeset, _opts, context) do
    Ash.Changeset.before_transaction(changeset, fn changeset ->
      ...
      messages =
        Thunderline.Thunderlink.Chat.Message
      ...
      |> AshAi.setup_ash_ai(otp_app: :thunderline, tools: [], actor: context.actor)
