defmodule Thunderline.Thunderlink.Transport.Routing.HysteresisManager do
  @moduledoc """
  Dynamic hysteresis adjustment control for Thunderlink Transport.
  """
  use GenServer
  require Logger
  ...
  def handle_info(:revert, state) do
    Logger.info("[Thunderlink][Hysteresis] Reverting hysteresis to base #{state.base}%")
