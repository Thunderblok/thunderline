defmodule Thunderline.Thunderlink.Transport.Telemetry.Aggregator do
  @moduledoc """
  Aggregates selected transport security telemetry events into counters
  accessible to simulators or health endpoints. Minimal in-memory (GenServer).
