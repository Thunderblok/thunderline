defmodule Thunderline.Thunderblock.Resources.VaultMemoryNode do
  ...
  actions do
    ...
    create :store_memory do
      accept [:agent_id, :title, :content, :content_type, :importance,
              :emotional_valence, :confidence, :tags, :context, :parent_memory_id]
    ...
    update :decay_memory do
      ...
      change fn changeset, _context ->
        current_importance = Ash.Changeset.get_attribute(changeset, :importance) || Decimal.new("0.5")
  ...
  calculations do
    calculate :memory_strength, :decimal,
    ...
    calculate :days_since_access, :integer,
  ...
  validations do
    ...
    validate numericality(:emotional_valence, greater_than_or_equal_to: -1, less_than_or_equal_to: 1)
