  ...
  **NOT a blockchain** - This is a distributed execution container system.
  ...
  attributes do
    ...
    attribute :status, :atom,
      constraints: [one_of: [:idle, :running, :paused, :completed, :failed, :terminated]]

    attribute :container_type, :atom,
      constraints: [
        one_of: [:task_executor, :batch_processor, :stream_processor, :federation_bridge]
      ]

    attribute :resource_limits, :map,
      default: %{
        cpu_limit: 1.0,
        memory_mb: 512,
        disk_mb: 1024,
