defmodule Thunderline.Thundergate.Resources.ExternalService do
  ...
  actions do
    ...
    read :unhealthy do
      filter expr(
               status == :error or
                 (not is_nil(last_health_check) and last_health_check < ago(300, :second))
             )
    end
  end
  ...
  attributes do
    ...
    attribute :protocol_type, :atom,
      constraints: [one_of: [:rest, :graphql, :grpc, :webhook, :legacy]]
