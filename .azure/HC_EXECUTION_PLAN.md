...
| **HC-03** | Documentation | Finalize EVENT_TAXONOMY + ERROR_CLASSES assets. | Observability Lead | Week 1, Days 3-5 | HC-01 schema enforcement hooks | - Versioned taxonomy + error schema committed<br>- CI lint references the artifact<br>- Docs cross-linked from code |
